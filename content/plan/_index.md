...
Nombre y Apellido		| Categoria		| Dedicación	| Horario													|
------------------------|---------------|---------------|-----------------------------------------------------------|
Mirtha Eve Giovannini	| Titular		| 2 DS 			| Martes 11.40 hs a 13.10 hs <br/>Jueves 9.15 hs a 10.55 hs |
Diego Bolatti			| Adjunto		| 1 DS 			| Jueves 18.00 hs a 19.30 hs 								|
Noelia Pinto			| Adjunto		| 1 DS 			| Viernes 17.10 hs a 18.40 hs 								|
...
Nombre y Apellido		| Categoria				| Dedicación	| Horario															|
------------------------|-----------------------|---------------|-------------------------------------------------------------------|
Ilse Hodapp				| JTP					| 1 DS 			| Miércoles 16.25 hs a 18.40 hs <br/> Miércoles 18.45 hs a 21.00 hs |
Nicolas Tortosa			| JTP					| 1 DS 			| Viernes 8.30 hs a 10.55 hs <br/> Viernes 10.55 hs a 13.15 hs		|
Juan Esteban Colcombet	| Auxiliar 1<sup>ra<sup>| 1 DS 			| Miércoles 16.25 hs a 18.40 hs <br/> Miércoles 18.45 hs a 21.00 hs |
Nelson Yaccuzzi			| Auxiliar 1<sup>ra<sup>| 1 DS 			| Miércoles 16.25 hs a 18.40 hs <br/> Miércoles 18.45 hs a 21.00 hs |
Emiliano Pollero		| Auxiliar 2<sup>da<sup>| 1 DS 			| Viernes 8.30 hs a 10.55 hs <br/> Viernes 10.55 hs a 13.15 hs		|
Mauro Rojas				| Auxiliar 2<sup>da<sup>| 1 DS 			| Viernes 8.30 hs a 10.55 hs <br/> Viernes 10.55 hs a 13.15 hs		|
...
##### _Unidad II: Secuencias_

###### _Subunidad A: Noción de Secuencia_
...
###### _Subunidad B: Descomposición y Tratamiento de Secuencias_
...
##### _Unidad III: Estructuras de Datos_

###### _Subunidad A: Campo, registro, archivo_
...
Concepto de datos estructurados. Clasificación en estáticos y dinámicos.
...
##### _Unidad IV: Algoritmos y estructuras recursivas_
...
##### _Unidad V: Complejidad computacional y nocion de orden_
...
1. **Exámenes parciales**: Se evaluara individualmente por parcial de complejidad creciente. Se tomarán 3 (tres) parciales.  
2. **Cuestionarios en el aula virtual**: se han programado 21 (veintiun) cuestionarios de autogestión individuales.  
3. **Trabajo de cierre del laboratorio**: se preveen 2 (dos), uno por cada lenguaje, modalidad grupal y colaborativa.  
4. **Trabajo práctico integrador**: se preveen 1 (uno), modalidad grupal y colaborativa.
...
4.	Debe promediar como mínimo una nota 6(seis) entre los trabajos de cierre de los laboratorios.
5.	Debe aprobar el Trabajo Practico Integrador.
...
3.	Debe promediar como mínimo una nota 6(seis) entre los cuestionarios del aula virtual.
4.	Debe promediar como mínimo una nota 6(seis) entre los trabajos de cierre de los laboratorios.
5.	Debe aprobar con una nota 6(seis) en el Trabajo Practico Integrador.  
...
2. Se le habilitarán nuevamente 5 (cinco) cuestionarios, para poder promediar nuevamente esta instancia. Los que se habilitarán recien al final del cursado, y tendrá solo una semana de tiempo para su resolución.  
3. Podrán presentar nuevamente los cierres de laboratorios, en los recuperatorios que se consignan en el calendario.  
